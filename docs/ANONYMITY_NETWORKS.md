# Anonymity Networks with Bonero

Currently only Tor and I2P have been integrated into Bonero. The usage of
...
system clock is fairly accurate - many peers on the Bonero network should have
similar timestamps.
